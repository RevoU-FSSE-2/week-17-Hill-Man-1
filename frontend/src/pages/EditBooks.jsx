...
const EditBook = () => {
  ...
  useEffect(() => {
    setLoading(true)
    axios.get(`https://us-central1-revou-fullstack.cloudfunctions.net/hilman/books/${id}`)
    .then((res) => {
  ...
  const handleEditBook = () => {
    ...
    setLoading(true)
    axios
    .put(`https://us-central1-revou-fullstack.cloudfunctions.net/hilman/books/${id}`, data)
    .then(() => {
      setLoading(false);
      navigate('/')
    })
